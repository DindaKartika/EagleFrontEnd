    ...
    return (
        <footer className="container-fluid footer">
            <div className="container footer-handler row">
                <div className="footer-logo col-md-4"><img className="logo-footer" src={require("../images/logo/testlogo9.png")} alt="" /></div>
                <div className="footer-logo col-md-4">
                    <p><strong><Link to="/landinginfo"><span className="fontFooter bold">Tentang </span></Link></strong></p>
                    <p className="menu-footer"><Link to="/landinginfo"><span className="fontFooter">Info</span></Link> <br />
                    <Link to="/maps"><span className="fontFooter">Peta</span></Link> <br />
                    <Link to="/newsfeed"><span className="fontFooter">Feeds</span></Link></p> 
                </div>
                <div className="footer-logo col-md-4">
                    <p><strong><Link to="/aboutus"><span className="fontFooter bold">Pusat Bantuan </span></Link></strong></p>
                    <p className="menu-footer"><Link to="/aboutus"><span className="fontFooter">Menggunakan Lahanku.id</span></Link><br />
            ...
            <div className="justify-content-center">
                <hr />
                <p className="copyright-footer">copyright lahanku.id</p>
            </div>
        </footer>
    );
  }
