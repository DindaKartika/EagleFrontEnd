                            ...
                            <div className="form-group">
                                ...
                                <div className="cols-sm-10">
                                    <div className="input-group">
                                        ...
                                        <input type="text" className="form-control font14px" name="username" id="username" placeholder="Enter your Username" onChange= {e => this.props.changeInput(e)} required autofocus/>
                                    </div>
                                </div>
                            </div>
                            <div className="form-group">
                                ...
                                <div className="cols-sm-10">
                                    <div className="input-group">
                                        ...
                                        <input type="password" className="form-control font14px" name="password" id="password" placeholder="Enter your Password"  onChange= {e => this.props.changeInput(e)} required />
                                    </div>
                                </div>
                            </div>
