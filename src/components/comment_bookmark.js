            ...
            <li className="media">
                ...
                <div className="media-body">
                    ...
                    <div className="row justify-content-end">
                        ...
                        <a  className="cursor-feed margin-right-20"  name={this.props.id}><i className="fa fa-gittip"></i> Suka</a>
                        ...
                        <a className="cursor-feed attribute-text " onClick={(e)=>this.handleDeleteComment(e)} style={{ display: this.props.current_id !== this.props.iduser ? "none" : "block" }} name={this.props.id}>Delete</a>
                    </div>
                </div>
            </li>
        </div>
